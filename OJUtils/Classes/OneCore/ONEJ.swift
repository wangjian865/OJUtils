...
/*
 ...
 428pt（全面屏）
 */
public typealias OJApp = OneJAgileApp
@objcMembers
public class OneJAgileApp :NSObject {
    ...
    public static var displayName: String {
        ...
        return Bundle.main.infoDictionary?[kCFBundleNameKey as String] as? String ?? "OneJAgileApp"
    }
    
    /// app 的bundleid
    public static var bundleID: String {
        return Bundle.main.bundleIdentifier ?? "One.agile.app"
    }
    ...
    public static var topNavVC: UINavigationController? {
        if let topVC = self.topVC() {
            if let nav = topVC.navigationController {
                ...
                return ONEJNavigationController(rootViewController: topVC)
            }
        }
        return nil
    }
